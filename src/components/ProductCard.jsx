...
const ProductCard = ({ product, addToCart, viewMode = 'grid' }) => {
  ...
  if (viewMode === 'list') {
    return (
      <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border border-gray-200/50 hover:border-blue-200">
        <div className="flex flex-col sm:flex-row">
          {/* Imagen */}
          <div className="relative w-full sm:w-48 lg:w-56 h-48 sm:h-auto overflow-hidden bg-gray-100">
            {!imageLoaded && (
            ...
            <div>
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                  <h3 className="font-bold text-lg text-gray-900 line-clamp-2 mb-1 hover:text-blue-600 transition-colors cursor-pointer">
                    {product.name}
                  </h3>
                ...
                <button
                  onClick={handleLike}
                  className={`p-2 rounded-full transition-all duration-300 ml-3 ${
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group border border-gray-200/50 hover:border-blue-200 hover:-translate-y-1">
      ...
      {/* Quick View Modal rediseñado */}
      {showQuickView && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowQuickView(false)}>
