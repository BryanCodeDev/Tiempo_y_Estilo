        ...
        <div className="min-h-screen bg-gradient-to-br from-white via-amber-50/30 to-white flex items-center justify-center p-3 sm:p-4">
          <div className="max-w-sm sm:max-w-md lg:max-w-lg w-full">
            ...
            <div className="glass-luxury rounded-3xl shadow-2xl p-8 text-center border border-secondary/20">
              {/* Icono de error */}
              <div className="mx-auto w-20 h-20 bg-gradient-to-br from-red-100 to-red-50 rounded-full flex items-center justify-center mb-6 border border-red-200">
              ...
              {this.state.errorId && (
                <div className="mt-6 p-4 bg-gradient-to-br from-amber-50 to-white rounded-xl border border-secondary/20">
            ...
            {isDevelopment && this.state.error && (
              <div className="mt-6 bg-red-50 border border-red-200 rounded-2xl p-4">
                ...
                <details className="text-xs">
                  <summary className="cursor-pointer text-red-700 hover:text-red-900 mb-2 font-semibold">
                    Ver detalles del error
                  </summary>
                  <div className="glass-luxury p-3 rounded-xl border border-red-200 mt-2">
                    <p className="font-mono text-red-600 mb-2 font-semibold">
            ...
            <div className="mt-6 text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-700 text-sm font-bold transition-colors"
              >
