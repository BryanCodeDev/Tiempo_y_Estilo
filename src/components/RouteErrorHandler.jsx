    ...
    switch (type) {
      case '404':
        return {
          ...
          icon: AlertCircle,
          iconColor: 'text-luxury',
          iconBg: 'bg-luxury-100'
        };
            ...
            <div className="mb-8">
              <div className="relative mb-4">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-luxury focus:border-luxury outline-none transition-colors"
                />
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
                {isSearching && (
                  <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                    <RefreshCw className="w-5 h-5 text-luxury animate-spin" />
                  </div>
                )}
              </div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {suggestions.map((product, index) => (
                    <button
                      ...
                      className="w-full text-left p-3 bg-luxury-50 hover:bg-luxury-100 rounded-lg transition-colors duration-200 border border-luxury-200"
                    >
          ...
          <div className="space-y-3">
            ...
            {type === 'connection-error' ? (
              <button
                ...
                className="w-full bg-luxury hover:opacity-90 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2"
              >
        ...
        <div className="mt-6 text-center space-y-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <button
                ...
                className="text-luxury hover:text-luxury py-2 px-3 rounded-lg hover:bg-luxury-50 transition-colors"
              >
                Tecnología
              </button>
              <button
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-whatsapp-600 hover:text-whatsapp-700 font-medium transition-colors"
            >
